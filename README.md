...
**Development Status:** Last updated 	21/01/22

* 0.86 pre-release
* Connection auto-select of Serial, SITL and Vehicle during startup
...
* Re-connect issues fixed
* UI and responsivenes fixes
